-- =============================================================================
-- YAKOUB BIG BOSS — complete database install
-- Migrations 0001-0016 in order, then the system seed.
-- Target: PostgreSQL 15+ (verified on 17.6)
--
-- EXCLUDED, deliberately:
--   0005b_variant_uniqueness_pg14_fallback.sql  (only if PG <= 14)
--   seed/0002_geography.PENDING.sql             (pending wilaya codes)
-- =============================================================================
